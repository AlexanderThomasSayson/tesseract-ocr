...
@Service
public class VoucherRedemptionFormServiceImpl implements VoucherRedemptionFormService {

    private final TextractClient textractClient;

    public VoucherRedemptionFormServiceImpl(TextractClient textractClient) {
